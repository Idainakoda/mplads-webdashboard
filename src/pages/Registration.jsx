...
function Registration() {
    ...
    return (
        <div className="min-h-screen bg-[#f4f8fc] flex items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
                <div className="bg-[#092d52] text-white px-6 sm:px-10 py-7">
                    ...
                    <p className="text-sm text-white/60 mt-3">
                        Register your official account to access the MPLADS Monitor platform.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 sm:p-10">
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-slate-400 mt-1">
                            Enter your official details as provided by your department.
                        </p>
                    </div>
                    ...
                    <p className="text-center text-xs text-slate-400 mt-5">
                        Your registration will be subject to official verification.
                    </p>
                </form>
            </div>
        </div>
